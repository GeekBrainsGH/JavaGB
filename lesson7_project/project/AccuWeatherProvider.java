...
public class AccuWeatherProvider implements WeatherProvider {
    ...
    private static final String CURRENT_CONDITION = "1day";
    private static final String FIVE_DAYS_CONDITION = "5day";
    ...
    public void getWeather(Periods periods) throws IOException {
        ...
        if (periods.equals(Periods.NOW)) {
            HttpUrl url = new HttpUrl.Builder()
                ...
                .addPathSegment(CURRENT_CONDITION)
        ...
        if (periods.equals(Periods.FIVE_DAYS)) {
            HttpUrl url = new HttpUrl.Builder()
                    ...
                    .addPathSegment(API_VERSION)
                    .addPathSegment(FORECAST_TYPE)
                    .addPathSegment(FIVE_DAYS_CONDITION)
                    .addPathSegment(cityKey)
                    .addQueryParameter("apikey", API_KEY)
                    .addQueryParameter("language", "ru-ru")
                    .addQueryParameter("metric", "true")
            ...
            Response response = client.newCall(request).execute();
            String jResponseWeather = response.body().string();
            WeatherResponse weatherResponse = new WeatherResponse();
            weatherResponse.weatherRersponse(jResponseWeather);
    ...
    public String detectCityKey() throws IOException {
        ...
        if (objectMapper.readTree(jsonResponse).size() > 0) {
            ...
            System.out.println("В городе " + cityName + " на дату:");
