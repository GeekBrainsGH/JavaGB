...
public class UserInterface {
    ...
    public void runApplication() {
        ...
        while (true) {
            System.out.println("Введите название города на английском языке. Для выхода из программы введите выход (exit).");
    ...
    private void validateUserInput(String userInput) throws IOException {
        if (userInput == null /*|| userInput.length() != 1 || userInput.length() != 2*/) {
